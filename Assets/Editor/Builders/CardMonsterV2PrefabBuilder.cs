...
public static class CardMonsterV2PrefabBuilder
{
    ...
    const string SrcCardPath    = "Assets/Prefabs/Card.prefab";
    const string FramesDir      = "Assets/Art/Sprites/CardFrames";
    const string StarSpritePath = FramesDir + "/level_star.png";
    const string FrameSpritePath = FramesDir + "/frame_v4.png";    // FORMA del marco (máscara), líneas finas
    const string CardBasePath    = FramesDir + "/card_base_v3.png"; // silueta obsidiana con esquinas cortadas
    const string MetalTexPath    = FramesDir + "/metal_gold.png";  // TEXTURA metálica que rellena el marco (swappable)
    const string FoilMatPath     = "Assets/Art/Materials/CardV2Foil.mat"; // material shader YGO/CardV2Foil (cristal + brillo diagonal)
    ...
    static Sprite EnsureStarSprite()
    {
        ...
        System.IO.Directory.CreateDirectory(System.IO.Path.GetDirectoryName(StarSpritePath));
    ...
    static Sprite EnsureVignetteSprite() => SavePng(FramesDir + "/vignette.png", 128, (x, y) =>
    {
