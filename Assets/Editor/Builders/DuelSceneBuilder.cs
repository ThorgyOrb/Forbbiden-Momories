...
public static class DuelSceneBuilder
{
    ...
    public static void BuildInScene(DuelController controller)
    {
        ...
        var iconConfig = AssetDatabase.LoadAssetAtPath<CardIconConfig>("Assets/Data/CardIconConfig.asset");
        ...
        var testConfig = AssetDatabase.LoadAssetAtPath<DuelConfig>("Assets/Data/DuelConfigs/Heishin_DuelConfig.asset");
